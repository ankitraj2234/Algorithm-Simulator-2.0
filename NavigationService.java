...
public class NavigationService {
    ...
    /**
     * ENHANCED: Async module opening with better error handling and responsive design
     */
    ...
    private void positionWindow(Stage stage) {
        ...
        if (openWindows.isEmpty()) {
            ...
            System.out.println("📐 Cascaded window at: (" + (baseX + cascadeOffset) + ", " + (baseY + cascadeOffset) + ")");
        }
    }
    /**
